...
declare const wx: {
    ...
    setInnerAudioOption(obj: { mixWithOther: boolean, obeyMuteSwitch: boolean })

    navigateToMiniProgram(obj: { appId: string, path: string, extraData: object, envVersion?: string,
    ...
    createBannerAd(obj: { adUnitId: string, style?: { left: number, top: number, width: number, height: number } }): BannerAd;

    createGameClubButton(obj: { type: string, text: string, image: string, 
        style: { left: number, top: number, width: number, height: number, 
            backgroundColor?: string, borderColor?: string, borderWidth?: number, 
            borderRadius?: number, textAlign?: string, fontSize?: number, lineHeight?: number }, icon: string }): any

    createUserInfoButton(obj: { type: string, text: string, image: string, 
        style: any, withCredentials: boolean, lang: string }): UserInfoButton;
    /**
     ...
     * 主动拉起转发，进入选择通讯录界面。
     */
    shareAppMessage(object: {title:string,imageUrl:string,query:string,success?:(res:any)=>void,fail?:(res:any)=>void,complete?:(res:any)=>void,cancel?:(res:any)=>void}): void;
     ...
     * 显示模态对话框
     */
    showModal(object: {title:string,content:string,showCancel?:boolean,cancelText?:string,cancelColor?:string,confirmText?:string,confirmColor?:string,
        success?:(res:any)=>void,fail?:(res:any)=>void,complete?:(res:any)=>void}): void;
    /**
     * 显示消息提示框
     */
    showToast(object: {title:string,duration?:number,mask?:boolean,icon?:string,image?:string,success?:(res:any)=>void,fail?:(res:any)=>void,complete?:(res:any)=>void}): void;
     ...
     * 预览图片
     */
    previewImage(object: {urls:any[],current?:string,success?:(res:any)=>void,fail?:(res:any)=>void,complete?:(res:any)=>void}): void;
    saveImageToPhotosAlbum(object: {filePath:string,success:(res:any)=>void,fail:(res:any)=>void,complete:(res:any)=>void}): void;
    /**
     * 创建视频
     */
    createVideo(object: {x?:number,y?:number,width?:number,height?:number,src:string,poster:string,initialTime?:number,playbackRate?:number,live?:boolean,
        objectFit?:string,controls?:boolean,autoplay?:boolean,loop?:boolean,muted?:boolean,
        enableProgressGesture?:boolean,enablePlayGesture?:boolean,showCenterPlayBtn?:boolean}): Video;
    /**
     * 获取性能管理器
     */
...
declare interface Canvas {
     ...
     * 获取画布对象的绘图上下文
     */
    getContext(contextType: string, contextAttributes?: {antialias:boolean,preserveDrawingBuffer:boolean,antialiasSamples:number}): any;
    /**
...
declare interface UpdateManager {
     ...
     * 监听检查更新结果回调
     */
    onCheckForUpdate(callback: (res: any)=>void): void;
    /**
     * 监听更新包下载成功回调
     */
...
declare class UserInfoButtonStyle {
    //左上角横坐标
    left: number;
    //左上角纵坐标
    top: number;
...
declare interface UserInfoButton {
    ...
    //监听用户点击事件
    onTap(cb: (res: { userInfo: UserInfo, rawData: string, 
        signature: string, encryptedData: string, iv: string }) => void);
...
declare interface InterstitialAd {
    ...
    /** 取消错误事件监听 */
    offError(cb?: Function);

    /** 监听关闭事件 */
    onClose(cb?: Function);

    /** 取消关闭事件 */
    offClose(cb?: Function);
}
...
//     drawImage(img: Image, x: number, y: number)
// }
