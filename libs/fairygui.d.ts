...
declare type FGUIButton = fgui.GButton
declare type FGUICom = fgui.GComponent
declare type FGUICombox = fgui.GComboBox
declare type FGUIImage = fgui.GImage
declare type FGUILabel = fgui.GLabel
declare type FGUILoader = fgui.GLoader
declare type FGUIList = fgui.GList
declare type FGUIGroup = fgui.GGroup
declare type FGUIMovieClip = fgui.GMovieClip
declare type FGUITextField = fgui.GTextField
declare type FGUIProgress = fgui.GProgressBar
declare type FGUISlider = fgui.GSlider
declare type FGUIScrollBar = fgui.GScrollBar
declare type FGUITextInput = fgui.GTextInput
declare type FGUIRichText = fgui.GRichTextField
declare type FGUIGraph = fgui.GGraph
declare type FGUIBasicTextField = fgui.GBasicTextField
declare type FGUIObj = fgui.GObject
declare type FGUIWindow = fgui.Window
declare type FGUIPopup = fgui.PopupMenu
declare type FGUITrans = fgui.Transition
declare type FGUIEvents = fgui.Events
declare type FGUICtrl = fgui.Controller